...
- `skills/dedicated-server/SKILL.md` — Section "1. Headless Export" — short: C# `OS.HasFeature("dedicated_server")` boot check, `RenderingServer.SetRenderLoopEnabled(false)`; export preset guidance is language-agnostic

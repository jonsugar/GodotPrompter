...
> **Related skills:** **state-machine** for state management, **player-controller** for movement-driven animation, **component-system** for reusable animation components, **2d-essentials** for TileMaps, parallax, lights, and canvas layers, **3d-essentials** for AnimationTree and 3D animation blending, **shader-basics** for shader-driven hit flash and dissolve effects, **tween-animation** for code-driven motion alongside keyframe animation.
